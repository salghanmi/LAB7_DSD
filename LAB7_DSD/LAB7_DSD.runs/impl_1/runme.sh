...
HD_PWD='/home/it/LAB7_DSD/LAB7_DSD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_LOCK_PARTC_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Digital_LOCK_PARTC_FPGA.tcl -notrace
