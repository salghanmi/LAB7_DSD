...
HD_PWD='/home/it/LAB7_DSD/LAB7_DSD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digital_LOCK_PARTC_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digital_LOCK_PARTC_FPGA.tcl
